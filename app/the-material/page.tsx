  ...
  return (
    <>
      ...
      <Container className="py-24 lg:py-32 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
        <Reveal className="lg:col-span-5 lg:sticky lg:top-28 self-start space-y-3">
          <p className="label">Chapter one</p>
          <h2 className="font-display text-display-md text-balance">The Material.</h2>
        </Reveal>
        <Reveal className="lg:col-span-7 space-y-6 text-base leading-relaxed text-ink/85" delay={0.1}>
          <p>
      ...
      <section className="bg-ink text-bone py-24 lg:py-32 grain">
        <Container className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start relative">
          ...
          <Reveal className="lg:col-span-7 space-y-6 text-base leading-relaxed text-bone/85" delay={0.1}>
            <p>
      ...
      <Container className="py-24 lg:py-32 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
        ...
        <Reveal className="lg:col-span-7 space-y-6 text-base leading-relaxed text-ink/85" delay={0.1}>
          ...
          <Link href="/shop" className="btn-outline mt-2" data-cursor="hover">Browse the catalogue</Link>
        </Reveal>
      </Container>
    </>
  );
